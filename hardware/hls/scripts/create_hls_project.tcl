...
add_files      $SRC_DIR_IP/utils/strobe_gen.cpp                   -cflags $CPPFLAGS_CSIM
...
add_files      $SRC_DIR_IP/utils/fm_demodulator.cpp               -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/channel_decoder/recover_carriers.hpp
add_files      $SRC_DIR_IP/channel_decoder/recover_carriers.cpp   -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/channel_decoder/recover_lrdiff.hpp
add_files      $SRC_DIR_IP/channel_decoder/recover_lrdiff.cpp     -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/channel_decoder/recover_mono.hpp
add_files      $SRC_DIR_IP/channel_decoder/recover_mono.cpp       -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/channel_decoder/separate_lr_audio.hpp
add_files      $SRC_DIR_IP/channel_decoder/separate_lr_audio.cpp  -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/channel_decoder.hpp
add_files      $SRC_DIR_IP/channel_decoder.cpp                    -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/fm_receiver.hpp
add_files      $SRC_DIR_IP/fm_receiver.cpp                        -cflags $CPPFLAGS_CSIM
add_files      $SRC_DIR_IP/fm_receiver_hls.hpp
add_files      $SRC_DIR_IP/fm_receiver_hls.cpp                    -cflags $CPPFLAGS_CSIM
