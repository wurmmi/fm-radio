...
entity fm_radio_axi is
  ...
  port (
    ...
    s_axi_awaddr_i  : in  std_ulogic_vector(11 downto 0);
    ...
    s_axi_araddr_i  : in  std_ulogic_vector(11 downto 0);
  ...
  begin -- process reading
    if s_axi_areset_i = '1' then
      ...
      case to_integer(axi_araddr) is
        ...
        when 12 =>
          axi_rdata(3 downto 0) <= fm_version_addr_value;
          axi_rresp <= axi_okay_c;

        when 16 =>
          axi_rdata(31 downto 0) <= fm_version_value;
          axi_rresp <= axi_okay_c;
