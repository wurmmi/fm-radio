...
class FM_RECEIVER_MODEL(object):
    ...
    def loadModelData(self):
        ...
        self.gold_audio_mono_fp = loadDataFromFile(filename, self.num_samples_c, fp_width_c, fp_width_frac_c)
        ...
        self.gold_audio_lrdiff_fp = loadDataFromFile(
            filename, self.num_samples_c, fp_width_c, fp_width_frac_c)

        filename = directory + "rx_audio_L.txt"
        self.gold_audio_L_fp = loadDataFromFile(filename, self.num_samples_c, fp_width_c, fp_width_frac_c)

        filename = directory + "rx_audio_R.txt"
        self.gold_audio_R_fp = loadDataFromFile(filename, self.num_samples_c, fp_width_c, fp_width_frac_c)
