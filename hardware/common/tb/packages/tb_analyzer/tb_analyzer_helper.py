...
def analyze():
    ...
    # Compare
    ok_fm_demod = compareResultsOkay(model.gold_fm_demod_fp,
    ...
    ok_audio_mono = compareResultsOkay(model.gold_audio_mono_fp,
    ...
    ok_pilot = compareResultsOkay(model.gold_pilot_fp,
    ...
    ok_carrier_38k = compareResultsOkay(model.gold_carrier_38k_fp,
    ...
    ok_audio_lrdiff = compareResultsOkay(model.gold_audio_lrdiff_fp,
    ...
    ok_audio_L = compareResultsOkay(model.gold_audio_L_fp,
    ...
    ok_audio_R = compareResultsOkay(model.gold_audio_R_fp,
