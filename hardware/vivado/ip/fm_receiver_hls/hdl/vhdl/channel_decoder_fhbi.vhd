...
entity channel_decoder_fhbi_rom is 
    generic(
             DWIDTH     : integer := 16; 
             AWIDTH     : integer := 7; 
             MEM_SIZE    : integer := 73
...
architecture rtl of channel_decoder_fhbi_rom is 
...
entity channel_decoder_fhbi is
    generic (
...
architecture arch of channel_decoder_fhbi is
    component channel_decoder_fhbi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    channel_decoder_fhbi_rom_U :  component channel_decoder_fhbi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
