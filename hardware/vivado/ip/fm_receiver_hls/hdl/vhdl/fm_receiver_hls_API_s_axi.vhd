...
architecture behave of fm_receiver_hls_API_s_axi is
    ...
    constant ADDR_STATUS_GIT_HASH_V_DATA_0   : INTEGER := 16#10#;
    constant ADDR_STATUS_GIT_HASH_V_CTRL     : INTEGER := 16#14#;
    constant ADDR_STATUS_BUILD_TIME_V_DATA_0 : INTEGER := 16#18#;
    constant ADDR_STATUS_BUILD_TIME_V_DATA_1 : INTEGER := 16#1c#;
    constant ADDR_STATUS_BUILD_TIME_V_CTRL   : INTEGER := 16#20#;
    constant ADDR_CONFIG_LED_CTRL_DATA_0     : INTEGER := 16#24#;
    constant ADDR_CONFIG_LED_CTRL_CTRL       : INTEGER := 16#28#;
