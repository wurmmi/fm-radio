...
architecture behav of fm_receiver_hls is 
    ...
    "fm_receiver_hls,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.457000,HLS_SYN_LAT=309,HLS_SYN_TPT=none,HLS_SYN_MEM=11,HLS_SYN_DSP=6,HLS_SYN_FF=1347,HLS_SYN_LUT=1815,HLS_VERSION=2018_2}";
...
begin
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if ((not(((audio_out_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state4_io))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    ap_done_assign_proc : process(audio_out_V_1_ack_in, ap_CS_fsm_state4, ap_block_state4_io)
    begin
        if ((not(((audio_out_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state4_io))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(audio_out_V_1_ack_in, ap_CS_fsm_state4, ap_block_state4_io)
    begin
        if ((not(((audio_out_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state4_io))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
