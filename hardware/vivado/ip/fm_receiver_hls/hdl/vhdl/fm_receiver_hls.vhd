...
architecture behav of fm_receiver_hls is 
    ...
    "fm_receiver_hls,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.457000,HLS_SYN_LAT=617,HLS_SYN_TPT=none,HLS_SYN_MEM=11,HLS_SYN_DSP=6,HLS_SYN_FF=1338,HLS_SYN_LUT=1779,HLS_VERSION=2018_2}";
    ...
    signal in_i_V_fu_157_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal in_i_V_reg_206 : STD_LOGIC_VECTOR (15 downto 0);
    signal in_q_V_reg_211 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_1_fu_181_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fm_receiver_fu_117_ap_idle : STD_LOGIC;
    signal grp_fm_receiver_fu_117_ap_ready : STD_LOGIC;
    signal grp_fm_receiver_fu_117_ap_done : STD_LOGIC;
    signal grp_fm_receiver_fu_117_ap_start : STD_LOGIC;
    signal grp_fm_receiver_fu_117_ap_return_0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fm_receiver_fu_117_ap_return_1 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fm_receiver_fu_117_ap_start_reg : STD_LOGIC := '0';
...
begin
    ...
    grp_fm_receiver_fu_117 : component fm_receiver
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_fm_receiver_fu_117_ap_start,
        ap_done => grp_fm_receiver_fu_117_ap_done,
        ap_idle => grp_fm_receiver_fu_117_ap_idle,
        ap_ready => grp_fm_receiver_fu_117_ap_ready,
        in_i_V_read => in_i_V_reg_206,
        in_q_V_read => in_q_V_reg_211,
        ap_return_0 => grp_fm_receiver_fu_117_ap_return_0,
        ap_return_1 => grp_fm_receiver_fu_117_ap_return_1);
    ...
    grp_fm_receiver_fu_117_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_fm_receiver_fu_117_ap_start_reg <= ap_const_logic_0;
            else
                if (((iq_in_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    grp_fm_receiver_fu_117_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_fm_receiver_fu_117_ap_ready = ap_const_logic_1)) then 
                    grp_fm_receiver_fu_117_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((audio_out_V_1_load_A = ap_const_logic_1)) then
                audio_out_V_1_payload_A <= tmp_1_fu_181_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((audio_out_V_1_load_B = ap_const_logic_1)) then
                audio_out_V_1_payload_B <= tmp_1_fu_181_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((iq_in_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                in_i_V_reg_206 <= in_i_V_fu_157_p1;
                in_q_V_reg_211 <= iq_in_V_0_data_out(31 downto 16);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (audio_out_V_1_ack_in = ap_const_logic_1))) then
                toggle <= tmp_s_fu_194_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, iq_in_V_0_vld_out, audio_out_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, grp_fm_receiver_fu_117_ap_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if ((not(((grp_fm_receiver_fu_117_ap_done = ap_const_logic_0) or (audio_out_V_1_ack_in = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    audio_out_V_1_vld_in_assign_proc : process(audio_out_V_1_ack_in, ap_CS_fsm_state3, grp_fm_receiver_fu_117_ap_done)
    begin
        if ((not(((grp_fm_receiver_fu_117_ap_done = ap_const_logic_0) or (audio_out_V_1_ack_in = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    grp_fm_receiver_fu_117_ap_start <= grp_fm_receiver_fu_117_ap_start_reg;
    in_i_V_fu_157_p1 <= iq_in_V_0_data_out(16 - 1 downto 0);
    ...
    led_out_assign_proc : process(ap_start, ap_CS_fsm_state1, led_ctrl, led_out_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
            led_out <= led_ctrl;
        else 
    ...
    tmp_1_fu_181_p3 <= (grp_fm_receiver_fu_117_ap_return_1 & grp_fm_receiver_fu_117_ap_return_0);
    tmp_s_fu_194_p2 <= (toggle xor ap_const_lv1_1);
end behav;
