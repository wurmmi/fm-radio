...
wire    grp_fm_receiver_fu_122_ap_start;
wire    grp_fm_receiver_fu_122_iq_in_V_TVALID;
wire    grp_fm_receiver_fu_122_iq_in_V_TREADY;
wire   [15:0] grp_fm_receiver_fu_122_ap_return_0;
wire   [15:0] grp_fm_receiver_fu_122_ap_return_1;
reg    grp_fm_receiver_fu_122_ap_start_reg;
wire    ap_CS_fsm_state2;
wire   [0:0] toggle_assign_fu_171_p2;
reg   [3:0] ap_NS_fsm;
...
#0 toggle = 1'd0;
#0 grp_fm_receiver_fu_122_ap_start_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_fm_receiver_fu_122_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_fm_receiver_fu_122_ap_start_reg <= 1'b1;
        end else if ((grp_fm_receiver_fu_122_ap_ready == 1'b1)) begin
            grp_fm_receiver_fu_122_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((~((grp_fm_receiver_fu_122_ap_done == 1'b0) | (audio_out_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_fm_receiver_fu_122_ap_start = grp_fm_receiver_fu_122_ap_start_reg;

assign grp_fm_receiver_fu_122_iq_in_V_TVALID = iq_in_V_0_state[1'd0];
