...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fm_receiver_hls/iq_in_V]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins fm_receiver_hls/s_axi_CONFIG] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net fm_receiver_hls_led_out [get_bd_ports fm_radio_led_o] [get_bd_pins fm_receiver_hls/led_out]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fm_receiver_hls/s_axi_CONFIG/Reg] SEG_fm_receiver_hls_Reg
