...
%  Audio signal processing, FM radio frequency, FPGA, HLS, VHDL, Matlab
  Audio signal processing, FM radio frequency, Matlab, Simulation
\end{IEEEkeywords}
...
\section{Introduction}
  ...
  This paper describes the necessary parts of signal processing, in order to listen to a radio station that is broadcast in the FM frequency band. Frequency modulation (FM) is a widely used standard to provide [...]
...
\section{Signal Processing Theory}
  ...
  %may be used freely, with limited power
