...
\label{sec_fm_sig_demod}
  ...
  \subsection{Frequency Discriminator}
    ...
    The differentiator would deliver wrong results because of this noise, when substracting two consecutive samples, as described in Equation \ref{equ_differentiator_two_samples}.
...
\section{Demodulation of Broadcast FM}
  ...
  \subsection{Stereo}
    ...
    In the channel frequency spectrum, there are two main parts of the audio signal, the left-right sum and -difference signals.
