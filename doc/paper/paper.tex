...
\section{Signal Processing Theory}
  ...
  \subsection{Frequency Band}
    ...
    This is also true worldwide, except that some countries only partially use the band. %http://search.itu.int/history/HistoryDigitalCollectionDocLibrary/1.43.48.en.101.pdf
    ...
    As an example, the German Federal Network Agency specifies the power limit as 50 nW, or -43 dBm, of effective radiated power (ERP). %https://tech.ebu.ch/docs/r/r120.pdf
  ...
  \subsubsection{FM Channel Allocation}
    %https://www.electronics-notes.com/articles/audio-video/broadcast-audio/vhf-fm-frequency-modulation-basics.php
    ...
    A signal that is constructed of the difference between left and right audio channel is modulated on the 38 kHz subcarrier.
    The bandwidth for the difference-signal spans 15 kHz on either side.
