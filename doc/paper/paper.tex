...
%  \subsection{Frequency Modulation}
  ...
  \subsection{Channel Frequency Spectrum}
    ...
    \begin{figure}[!h]
      ...
      \caption{Allocation of frequencies in an FM channel \cite{fig_channel_freqs}}
...
\label{sec_fm_sig_demod}
  ...
  \subsection{Frequency Discriminator, Slope detector}
    A frequency discriminator can be defined as a black box, with an output that is direclty proportional to the frequency of the input FM signal.

    different strategies in the black box.
    Here, the slope detector (differnetiator??) is used.

    This type of demodulator converts the FM signal into an AM signal, which still has an FM content.


  %https://www.tutorialspoint.com/analog_communication/analog_communication_fm_demodulators.htm
  %sect 3.3 : https://www.hs-schmalkalden.de/fileadmin/portal/Dokumente/Fakult%C3%A4t_ET/Personal/Roppel/Buch/Analoge_Modulationsverfahren.pdf

  \subsection{Phase-Locked Loop (PLL)}

\section{Demodulation of Broadcast FM}
  % mono:   just LP on 15 kHz
  % stereo: sum (L+R) + (L-R) = 2 L, (L+R) - (L-R) = 2R

  % page 30: https://www.hs-schmalkalden.de/fileadmin/portal/Dokumente/Fakult%C3%A4t_ET/Personal/Roppel/Buch/Analoge_Modulationsverfahren.pdf
...
\begin{thebibliography}{1}
  ...
  \bibitem{fig_channel_freqs}
    Fig.\ref{fig_channel_baseband_freqs}, Baseband Signal of an FM channel, \url{https://de.wikipedia.org/wiki/UKW-Rundfunk#Technische_Details}, opened on Dec. 11th, 2020
\end{thebibliography}
