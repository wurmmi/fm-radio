...
\begin{abstract}
  ...
  Fundamental knowledge about frequency modulation and its application in audio broadcast is presented.
  ...
  This demodulation itself can be done in different algorithms, of which a selection is introduced.
...
%  Audio signal processing, FM radio frequency, FPGA, HLS, VHDL, Matlab
  Audio signal processing, FM radio frequency, FM demodulation, Digital FM receiver, Matlab, Simulation
\end{IEEEkeywords}
...
\begin{thebibliography}{1}
  ...
  \bibitem{ref_eu_commision_radio_spectrum}
  ...
  \bibitem{ref_austria_rundfunkgesetz_2006}
  ...
  \bibitem{ref_fm_broadcast_tutorial_and_basics}
