...
The antenna signal needs to be amplified and filtered.
...
The intermediate frequency is then modulated, or mixed, down to baseband later in the digital domain, which brings advantages in the downstream processing chain. %TODO check this or explain more which advantages (HF to BB directly --> i/q complex signal? ; HF to IF to BB --> real signal ) ??
