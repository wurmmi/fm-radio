...
In order to decode the actual data content of the signals, they need to be converted down to become a baseband signal.
Again, there are multiple ways to achieve that.
In baseband, the signal can then be further processed, until the data content of interest is visible.

The block diagram in Fig.\ref{fig:bd_dsp_overview} gives a high-level overview of a receiver structure.

\includepicture [0.5] [0] {An overview of the signal processing chain.} {bd_dsp_overview} {img/draw.io/bd_dsp_overview}

% TODO: block diagram of receiver
% Antenna -->
% --> Analog Frontend (gain, filter, mixer to baseband)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Antenna signal to }

block diagram of superheterodyne
