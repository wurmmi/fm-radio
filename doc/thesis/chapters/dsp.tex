...
\includepicture [0.6] [0] {Frequency discriminator block diagram \cite{ref_fig_freq_discriminator}} {bd_freq_discriminator} {img/discrimination_method_bd1.jpg}
...
Therefore, the previous method only needs to swap the thresholding unit with an unit that calculates the absolut value.
...
explain multiplex signal somewhere
...
\subsection{Stereo}
  ...
  The rightmost part in the diagram performs the combination of summation and difference signals, according to Eq.\eqref{equ_stereo_from_sum_diff}.
