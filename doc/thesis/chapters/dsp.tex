...
Multiple different receiver structures exist and are implemented in receivers.
A very common structure is the so-called superheterodyne receiver.
In the literature, short forms like \textit{superhet}, or simply \textit{super} are found.
