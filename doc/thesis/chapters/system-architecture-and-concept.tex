...
\includepicture [1.0] [0] {Block diagram of the overall system concept. A common input source is used for the multiple implementations. The generated output files, including the used parameters, are verified in a common entity.} {bd_system_overview_detailed} {img/draw.io/bd_system_overview_detailed}
