...
A very high-level overview of the entire system is given the block diagram in Fig.\ref{fig:bd_system_overview_highlevel}.

\includepicture [0.8] [0] {Block diagram for a high-level overview of the system.} {bd_system_overview_highlevel} {img/draw.io/bd_system_overview_highlevel} [H]
