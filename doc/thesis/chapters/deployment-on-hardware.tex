...
The respective software drivers for the IPs that are used in the FPGA design are automatically imported into the SDK project.
They are embedded in the so-called hardware definition file (HDF) that is generated by Vivado after synthesis, and provided together with the bitstream file.
