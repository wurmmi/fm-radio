...
\textit{NOTE:}\\
Care needs to be taken when transmitting signals over the air.
...
Fig.\ref{fig:bd_gnuradio_transmitter} shows a block diagram of the application.

%\includepicture [1.0] [0] {Block diagram of the GNU Radio transmitter setup.} {matlab_analysis_freq_domain} {img/draw.io/gnuradio_setup_transmitter}
