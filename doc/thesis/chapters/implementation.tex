...
Just like the IPs' HDL code, the testbench is also written in the language \cplusplus.
The execution of the testbench is done in the Xilinx HLS software.

A major difference between a VHDL testbench and a HLS testbench is its execution speed.
HLS faster because it does not simulate any timing info; its just plain c++ code thats run
