...
testbench is using Firmware code to load the data! --> enables reuse and early testing on the code, before a hardware prototype exists\\

also, the same Python analyzer code is used as in the VHDL tb
