...
Fig.\ref{fig:bd_vhdl_implemented_tb_architecture} shows a block diagram of the implemented architecture.
...
The actual interfaces, as described in \ref{sub:FrameworkCocotb}, are hidden to maintain the overview of the implemented architecture.

\includepicture [1.0] [0]  {Block diagram of the implemented testbench architecture.} {bd_vhdl_implemented_tb_architecture} {img/draw.io/bd_vhdl_implemented_tb_architecture}
...
The \textit{tb\_analyzer\_helper} class provides functions to analyze the data, such as comparison against defined error thresholds or the creation of graphical plots.
...
However, Python can be used to actually implement an FM receiver, just like in Matlab.
