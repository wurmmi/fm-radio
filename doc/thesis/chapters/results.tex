...
This is visible in the analysis of the audio signal, as shown is Fig. \ref{fig:audio_output_compare_ips_vs_matlab}.
...
%TODO: find a good time-range for this picture and format it correctly
\includepicture [1.0] [0] {Comparison of the IPs audio signals against the Matlab model. The HLS variant matches the model, while the VHDL output diverts by a certain amount.} {audio_output_compare_ips_vs_matlab} {img/matlab/audio_output_compare_ips_vs_matlab}
...
%TODO: find a good time-range for this picture and format it correctly
\includepicture [1.0] [0] [H] {Comparison of the audio signal in simulation testbench and hardware.} {audio_output_compare_tb_vs_hw} {img/matlab/audio_output_compare_tb_vs_hw}
