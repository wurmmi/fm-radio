...
\begin{figure}%
  \centering
  \subfloat[\centering Overview of ]{{\includegraphics[trim=10 10 10 10,clip, width=0.5\textwidth]{img/matlab/lines_of_code_pie_chart_py_all} }}%
  \\
  %\hspace{\fill}
  \subfloat[\centering HLS]{{\includegraphics[trim=10 10 10 10,clip, width=0.5\textwidth]{img/matlab/lines_of_code_pie_chart_py_hls} }}%
  %\hspace{\fill}
  %\vspace{3cm}
  \subfloat[\centering VHDL]{{\includegraphics[trim=10 10 10 10,clip, width=0.5\textwidth]{img/matlab/lines_of_code_pie_chart_py_vhdl} }}%

  \caption{Lines of code of the respective system design parts, presented in multiple pie charts.}%
