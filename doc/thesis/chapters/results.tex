...
\includepicture [0.55] [0, trim=10 10 10 10, clip] {The implementation time of the implementation variants. Note the logarithmic scale of the y-axis.} {impl_time_analysis} {img/matlab/impl_time_analysis}
