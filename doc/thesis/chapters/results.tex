...
measurements are always including loading of data, running through DUT and storing the results.
exclusively result analysis, since this is shared and thus taking the same amount of time.
several measurements are done multiple times, to achieve a good average result, that is independent of the current processor load of the host PC.

Figure \ref{fig:impl_time_analysis} shows something
%
% VHDL:
%          time                   samples
%   audio         sim           in      out
...
\includepicture [0.55] [0, trim=10 20 10 10, clip] {The implementation time of the implementation variants. Note the logarithmic scale of the y-axis.} {impl_time_analysis} {img/matlab/impl_time_analysis}
