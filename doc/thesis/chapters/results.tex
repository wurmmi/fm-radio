...
Figure \ref{fig:hardware_utilization} shows the utilization numbers of different FPGA resources.


\includepicture [0.75] [0, trim=10 10 10 10, clip] {hardware utilization} {hardware_utilization} {img/matlab/hardware_utilization}
