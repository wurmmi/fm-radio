...
However, this may be inefficient to fit into available FPGA hardware.
...
In that way, the above example can be optimized to use a data type that has a bitwidth of 17 bit, which is wide enough for the application.
