...
Xilinx is the largest manufacturer of FPGAs globally and therefore its tool \textit{Xilinx HLS} is widely used.
...
Xilinx also decided in favor of the \cplusplus\ language for their tools \textit{Vivado HLS} and \textit{Vitis HLS}.
