...
\noindent
The execution of this type of simulation takes significantly longer, because timing information now actually needs to be considered for the RTL code, which is done by using an HDL simulator.
